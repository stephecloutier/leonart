...
<main>
    ...
    <a href="<?= sl_get_page_url('template-program.php'); ?>" class="link-back link-back--bottom link-back--artists" title="Retourner sur la page du programme">Retourner au programme</a>
</main>


<?php get_footer('artists'); ?>
